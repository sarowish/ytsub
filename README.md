...
"ctrl-J" = "jump_to_channel" # Jump to the channel of the selected video from latest videos mode
...
"c" = "copy_youtube_link" # Copy channel or video Youtube URL
"C" = "copy_invidious_link" # Copy channel or video Invidious URL
