...
pub enum Command {
    ...
    CopyYoutubeLink,
    CopyInvidiousLink,
    CopyYoutubeLinkAtTime,
    CopyInvidiousLinkAtTime,
    OpenInYoutube,
    OpenInInvidious,
    PlayFromFormats,
    PlayUsingYtdlp,
...
impl TryFrom<&str> for Command {
    ...
    fn try_from(command: &str) -> Result<Self, Self::Error> {
        let command = match command {
            ...
            "copy_youtube_link" => Command::CopyYoutubeLink,
            "copy_invidious_link" => Command::CopyInvidiousLink,
            "copy_youtube_link_at_time" => Command::CopyYoutubeLinkAtTime,
            "copy_invidious_link_at_time" => Command::CopyInvidiousLinkAtTime,
            ...
            "play_audio" => Command::PlayAudio,
            "play_audio_using_ytdlp" => Command::PlayAudioUsingYtdlp,
            "toggle_playback" => Command::TogglePlayback,
            "seek_backward" => Command::SeekPlaybackBackward,
            "seek_forward" => Command::SeekPlaybackForward,
            "increase_volume" => Command::IncreaseVolume,
            "decrease_volume" => Command::DecreaseVolume,
            "toggle_mute" => Command::ToggleMute,
            "stop_playback" => Command::StopPlayback,
            "release_video" => Command::ReleaseVideo,
