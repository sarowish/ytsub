...
impl TryFrom<&str> for Command {
    ...
    fn try_from(command: &str) -> Result<Self, Self::Error> {
        let command = match command {
            ...
            "toggle_audio" => Command::ToggleAudio,
            "seek_audio_backward" => Command::SeekAudioBackward,
            "seek_audio_forward" => Command::SeekAudioForward,
            "increase_audio_volume" => Command::IncreaseAudioVolume,
            "decrease_audio_volume" => Command::DecreaseAudioVolume,
            "toggle_audio_mute" => Command::ToggleAudioMute,
            "stop_audio" => Command::StopAudio,
